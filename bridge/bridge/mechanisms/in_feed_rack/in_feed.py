...
def __multiple_delayed_thread(items: list[Callable]) -> None:
    th: list[Thread] = []
...
def in_feed_to_passive() -> None:
    __multiple_delayed_thread([
