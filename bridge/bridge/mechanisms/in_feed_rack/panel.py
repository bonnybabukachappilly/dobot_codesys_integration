...
MECHANISM_NAME = 'm_TV_Rack_Panel'
TOOL_NAME = 't_TV_Rack_Panel'

# Frames
TOOL_FRAME = 'f_TV_Rack_Panel'
REF_PART_FRAME = 'f_Ref_TV_Rack_Panel'
TARGET_FRAME = 'f_TV_Rack_Rail_Targets'

# Objects
REF_PART_NAME = 'TVFrontPanel_Ref'

# Targets
TARGETS: dict[str, str] = {
    'corner_lb': 't_rack_panel_lb',
    'corner_lt': 't_rack_panel_lt',
    'corner_rt': 't_rack_panel_rt',
    'corner_rb': 't_rack_panel_rb',
    'active': 't_rack_panel_active',
    'passive': 't_rack_panel_passive'
}
...
class PanelFrames(NamedTuple):
    tool: Item
    ref_part: Item
    target: Item


class TVPanelMechanism:
    def __init__(self) -> None:
        ...
        self._targets: PanelTargets = self.__create_targets()
        self._frames: PanelFrames = self.__create_frames()
    ...
    def __create_frames(self) -> PanelFrames:
        return PanelFrames(
    ...
    def __create_targets(self) -> PanelTargets:
        _items: dict[str, Item] = {
            key: self._rdk.Item(name, robolink.ITEM_TYPE_TARGET)
            for key, name in TARGETS.items()
        }

        return PanelTargets(**_items)
